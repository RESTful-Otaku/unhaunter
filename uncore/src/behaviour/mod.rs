...
pub struct Behaviour {
    ...
    /// the code later on because we are not separating behaviour from raw data. Always
    /// place behavioural traits in "p: Properties" and never read or write from Cfg.
    cfg: SpriteConfig,
...
impl Behaviour {
    ...
    /// Creates the default components as required by this behaviour for a new entity.
...
/// Stores a collection of properties that define the behaviour of an object.
///
